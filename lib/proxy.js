...
module.exports.proxy.classes.AtomicCounterProxy = function(initial) {
    ...
    this.struct = scule.datastructures.getAtomicCounter(initial);
...
module.exports.proxy.classes.HashTableProxy = function(capacity) {
    ...
    this.struct = scule.datastructures.getHashTable(capacity);
...
module.exports.proxy.classes.HashMapProxy = function(capacity) {
    ...
    this.struct = scule.datastructures.getHashMap(capacity);
...
module.exports.proxy.classes.LRUCacheProxy = function(capacity) {
    ...
    this.struct = scule.datastructures.getLRUCache(capacity);
...
module.exports.proxy.classes.BitSetProxy = function(capacity) {
    ...
    this.struct = scule.datastructures.getBitSet(capacity);
...
module.exports.proxy.classes.BloomFilterProxy = function(capacity) {
    ...
    this.struct = scule.datastructures.getBloomFilter(capacity);
...
module.exports.proxy.classes.BinarySearchTreeProxy = function() {
    ...
    this.struct = scule.datastructures.getBinarySearchTree();
...
module.exports.proxy.classes.BPlusTreeProxy = function(order, threshold) {
    
    module.exports.proxy.classes.DataStructureProxy.call(this);
    
    this.struct = scule.datastructures.getBPlusTree(order, threshold);
    
    this.range = function(min, max, includeMin, includeMax) {
        return JSON.stringify(this.struct.range(min, max, includeMin, includeMax));
    };    
    
    this.get = function(key) {
        return this.struct.search(key);
    };
...
module.exports.proxy.classes.QueueProxy = function() {
    ...
    this.struct = scule.datastructures.getQueue();
...
module.exports.proxy.classes.FIFOStackProxy = function() {
    ...
    this.struct = scule.datastructures.getFIFOStack();
...
module.exports.proxy.classes.LIFOStackProxy = function() {
    ...
    this.struct = scule.datastructures.getLIFOStack();
...
module.exports.proxy.classes.LinkedListProxy = function() {
    ...
    this.struct = scule.datastructures.getLinkedList();
...
module.exports.proxy.classes.DoublyLinkedListProxy = function() {
    ...
    this.struct = scule.datastructures.getDoublyLinkedList();
...
/**
 * Returns an instance of the {BPlusTreeProxy} class
 * @param {Number} order
 * @param {Number} threshold
 * @returns {BPlusTreeProxy}
 */
module.exports.getBPlusTreeProxy = function (order, threshold) {
    return new module.exports.proxy.classes.BPlusTreeProxy(order, threshold);
};
