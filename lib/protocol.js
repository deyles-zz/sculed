...
module.exports.protocol.classes.ProtocolAdaptor = function(director) {
    ...
    this.decorate = function(o) {
        ...
        o.registerHandler('range', function(adaptor, frame) {
            ...
            if (struct === undefined) {
                ...
                var def = frame.getRangeDef().split(',');
...
module.exports.getProtocolAdaptor = function(director) {
    var adaptor   = new module.exports.protocol.classes.ProtocolAdaptor(director);
